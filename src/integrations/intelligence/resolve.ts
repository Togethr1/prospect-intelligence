...
import { enrichWithLusha } from './lusha'
import { enrichWithSeamless } from './seamless'
import { enrichWithSnov } from './snov'
import { enrichWithZoomInfo } from './zoominfo'
...
const runners: Record<string, (domain: string, credential: string) => Promise<IntelligenceResult>> = {
    ...
    lusha: enrichWithLusha,
    seamless: enrichWithSeamless,
    snov: enrichWithSnov,
    zoominfo: enrichWithZoomInfo,
}
